  ...
  return (
    <div className="flex flex-wrap gap-2 mb-8 justify-center">
      <Button
        ...
        className={`rounded-full ${activeFilter === "all" ? "bg-gray-900" : ""}`}
      ...
      <Button
        ...
        className={`rounded-full ${activeFilter === "development" ? "bg-gray-900" : ""}`}
      ...
      <Button
        ...
        className={`rounded-full ${activeFilter === "design" ? "bg-gray-900" : ""}`}
      ...
      <Button
        ...
        className={`rounded-full ${activeFilter === "career" ? "bg-gray-900" : ""}`}
